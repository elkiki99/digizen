...
<head>
    ...
    <title>{{ $title ?? config('app.name', 'Panel • Digizen') }}</title>

    <!-- Fonts -->
    <link rel="icon" href="{{ asset('img/dz-logo-white.png') }}" />
...
<body class="flex flex-col min-h-screen font-sans antialiased bg-white dark:bg-zinc-900 ">
    <div class="flex">
        ...
        <div class="flex-1 lg:ml-64">
            ...
            <!-- Main Content -->
            <main class="flex-1 p-8 mb-6 max-lg:max-w-2xl max-lg:mx-auto">
                {{ $slot }}
            </main>
        </div>    
    </div>
