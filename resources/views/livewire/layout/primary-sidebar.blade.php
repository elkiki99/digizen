...
<div>
    <flux:sidebar stashable sticky
        ...
        <flux:brand wire:navigate href="/" logo="{{ asset('dz-logo-black.png') }}" name="{{ config('app.name' )}}" class="px-2 dark:hidden" />
        <flux:brand wire:navigate href="/" logo="{{ asset('dz-logo-white.png') }}" name="{{ config('app.name' )}}"
