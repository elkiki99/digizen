<x-app-layout title="Case Studies • Digizen">
    <flux:main container>
        <!-- Hero section -->
            ...
            <div class="grid grid-cols-1 gap-4 pt-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <article>
                        <flux:card class="!bg-transparent !p-0">
                            <img class="rounded-t-lg rounded-b-none h-[30vh] sm:h-[25vh] md:h-[40vh] w-full object-cover"
                                src="{{ asset('img/success1.jpg') }}" alt="Success 1">
                            <div class="p-4">
                ...
                <a wire:navigate href="/blog">
                    <article>
                        <flux:card class="!bg-transparent !p-0">
                            <img class="rounded-t-lg rounded-b-none h-[30vh] sm:h-[25vh] md:h-[40vh] w-full object-cover"
                                src="{{ asset('img/success2.jpg') }}" alt="Success 2">
                            <div class="p-4">
                ...
                <a wire:navigate href="/blog">
                    <article>
                        <flux:card class="!bg-transparent !p-0">
                            <img class="rounded-t-lg rounded-b-none h-[30vh] sm:h-[25vh] md:h-[40vh] w-full object-cover"
                                src="{{ asset('img/success3.jpg') }}" alt="Success 3">
                            <div class="p-4">
