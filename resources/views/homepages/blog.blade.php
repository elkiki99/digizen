                ...
                <flux:card
                    ...
                    <div class="flex flex-col gap-4 lg:flex-row">
                        <div class="w-full lg:w-1/2">
                            <img class="object-cover w-full rounded-lg h-[60vh]" src="{{ asset('img/33.webp') }}" alt="Blog 1">
                        </div>
                    ...
                    <article>
                        <flux:card class="!bg-transparent !p-0">
                            <img loading="lazy"
                                ...
                                src="{{ asset('img/success1.jpg') }}" alt="Success Story 1">
                            <div class="p-4">
                ...
                <a wire:navigate href="#">
                    <article>
                        <flux:card class="!bg-transparent !p-0">
                            <img loading="lazy"
                                class="rounded-t-lg rounded-b-none h-[30vh] sm:h-[25vh] md:h-[40vh] w-full object-cover"
                                src="{{ asset('img/success2.jpg') }}" alt="Success Story 2">
                            <div class="p-4">
                ...
                <a wire:navigate href="#">
                    <article>
                        <flux:card class="!bg-transparent !p-0">
                            <img loading="lazy"
                                class="rounded-t-lg rounded-b-none h-[30vh] sm:h-[25vh] md:h-[40vh] w-full object-cover"
                                src="{{ asset('img/success3.jpg') }}" alt="Success Story 3">
                            <div class="p-4">
                    ...
                    <flux:card
                        ...
                        <a wire:navigate href="#">
                            <img loading="lazy" class="object-cover w-full h-full rounded-lg"
                                src="{{ asset('img/joe.jpg') }}" alt="Popular article 2">
                            <div
